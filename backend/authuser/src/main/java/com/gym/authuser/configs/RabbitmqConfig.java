package com.gym.authuser.configs;
...
public class RabbitmqConfig {
    ...
    //Acesso ao caminho da exchange, que está definido no application.yaml , esse exchangeUserEvent é utilizado nas futuras exchanges, como a direct definida lá embaixo
    ...
    //definição do exchange de tipo direct
    @Bean
    public DirectExchange directUserEvent() {
